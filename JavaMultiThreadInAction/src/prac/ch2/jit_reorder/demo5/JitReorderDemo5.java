package prac.ch2.jit_reorder.demo5;

public class JitReorderDemo5 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1000_000; i++) {
            ...
            new Thread(() -> {
                // copy in reverse order so if we see some invalid state we know this is caused by reordering and not
                // by a race condition in reads/writes
